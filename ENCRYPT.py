...
im = Image.open(os.path.join('C:\\Users\\kulvir\\Desktop\\DEV\\Flask-Image\\static\\uploads\\','1.PNG'))
...
Kr = [randint(0,pow(2,8)-1) for i in range(m)]
Kc = [randint(0,pow(2,8)-1) for i in range(n)]
